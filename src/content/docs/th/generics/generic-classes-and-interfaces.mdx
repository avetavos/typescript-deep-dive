...
เมื่อ class เป็น generic type parameter ของมันจะถูกเลือก **ตอนที่คุณ construct instance** และทุก method ของ instance นั้นใช้ร่วมกัน:
...
export const quizClasses = [
  ...
  },
  {
    ...
    options: [
      'มัน implement generic interface ไม่ได้',
