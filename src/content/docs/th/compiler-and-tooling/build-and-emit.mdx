...
export const quizBuild = [
  ...
  },
  {
    ...
    options: [
      'ลดขนาด output bundle',
      'ทำให้ type-check monorepo ใหญ่ ๆ เป็น incremental แทนที่จะ recheck ทุกอย่างใหม่ทุกครั้ง',
      'เพิ่ม runtime type check',
      'แทนที่ bundler',
    ],
    answer: 1,
  },
